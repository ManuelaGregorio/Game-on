...
if(vez==1){
document.getElementById("img"+casa).src="Imagens/xis.png"; //se o jogador for -1, coloca o desenho da bola
}else{
document.getElementById("img"+casa).src="Imagens/bola.jpg.png";
} 
